...
public class VehicleTests
{
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnSortedCatalogue_WhenOnlyCarsAreGiven()
    {
        // Arrange
        string[] input =
        {
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnSortedCatalogue_WhenOnlyTrucksAreGiven()
    {
        // Arrange
        string[] input =
        {
