...
public class PersonTests
{
    ...
    public void Test_GetByAgeAscending_SortsPeopleByAge()
    {
        ...
        string expected = $"Alice with ID: A001 is 30 years old.{Environment.NewLine}" +
            $"Bob with ID: B001 is 35 years old.{Environment.NewLine}" +
            $"Marry with ID: AB001 is 40 years old.";
